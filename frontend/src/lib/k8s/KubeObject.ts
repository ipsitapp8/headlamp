...
export class KubeObject<T extends KubeObjectInterface | KubeEvent = any> {
   ...
   */
  static useApiList() {
    // Hooks cannot be called in static methods. Use useKubeApiList instead.
  }
   ...
   */
  static useList() {
    // Hooks cannot be called in static methods. Use useKubeList instead.
    return { items: null, errors: null } as any;
  }
   ...
   */
  static useGet() {
    // Hooks cannot be called in static methods. Use useKubeGet instead.
   ...
   */
  static useApiGet() {
    // Hooks cannot be called in static methods. Use useKubeApiGet instead.
  }
