...
export class KubeObject<T extends KubeObjectInterface | KubeEvent = any> {
  ...
  static useApiList<K extends KubeObject>(
    ...
    void onError;
    void opts;
    // Hooks cannot be called in static methods. Use the standalone useKubeApiList hook instead.
  }
  ...
  static useList<K extends KubeObject>(
    this: (new (...args: any) => K) & typeof KubeObject<any>,
    opts: ApiListOptions & { refetchInterval?: number } = {}
  ): ReturnType<typeof useKubeObjectList<K>> {
    void opts;
    // Hooks cannot be called in static methods. Use the standalone useKubeList hook instead.
    const result: any = {
      items: null,
      errors: null,
  ...
  ): ReturnType<typeof useKubeObject<K>> {
    void name;
    void namespace;
    void opts;
    // Hooks cannot be called in static methods. Use the standalone useKubeGet hook instead.
  ...
  static useApiGet<K extends KubeObject>(
    ...
    void onError;
    void opts;
    // Hooks cannot be called in static methods. Use the standalone useKubeApiGet hook instead.
  }
...
/**
 * Hook to get a list of KubeObjects.
 *
 * @param kubeObjectClass - The class of the KubeObject to get.
 * @param onList - Callback function to be called when the list is retrieved.
 * @param onError - Callback function to be called when an error occurs.
 * @param opts - Options to be passed to the API endpoint.
 */
...
/**
 * Hook to get a list of KubeObjects and watch for changes.
 *
 * @param kubeObjectClass - The class of the KubeObject to get.
 * @param opts - Options to be passed to the API endpoint.
 */
...
/**
 * Hook to get a single KubeObject.
 *
 * @param kubeObjectClass - The class of the KubeObject to get.
...
/**
 * Hook to get a single KubeObject and watch for changes.
 *
 * @param kubeObjectClass - The class of the KubeObject to get.
 * @param onGet - Callback function to be called when the object is retrieved.
 * @param name - The name of the object.
 * @param namespace - The namespace of the object.
 * @param onError - Callback function to be called when an error occurs.
 * @param opts - Options to be passed to the API endpoint.
